...
$sql = "SELECT  `codigo_pr`, `nombre_pr`,`imagen_pr`,`precio_pr` FROM `producto` ORDER BY codigo_pr DESC $limit";
$query = mysqli_query($db_conx, $sql);
$paginationCtrls = '';
if($last != 1){
  if ($pagenum > 1) {
       ...
       $news .= ' <li>
                 ...
                 <hr>
                  <center> <h3>'.$nombre.'</h3></center>
                   <center> <small> Precio : $'.$precio.'</small></center>

                  <center><a class="btn btn-lg btn-primary" href="order.php?add='.$nombre.'&price='.$precio.'&qty=1"><i class="fa fa-shopping-cart"></i> Agregar a Carretilla</a></center>
                  <hr>
                  <br>
...
<div class="body-wrapper2">
    <br>
<center><h1>Estado de compra de productos</h1></center>
