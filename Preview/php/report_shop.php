          ...
          <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul id="active" class="nav navbar-nav side-nav">
                    ...
                    <li class="selected"><a href="report_shop.php"><i class="fa fa-shopping-cart"></i> Reporte de Compra</a></li>
                </ul>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <center><h1>REPORTE DE COMPRA</h1></center>
                    <center><hr width="600"></center>
                         
         <center> <p><strong><h2>A continuación, se encuentran las compras realizadas en la tienda.</h2></p>
</center>
<br>
<div class="panel-heading">
            <h3 class="panel-title">Reporte de Compra</h3>
          </div>
...
<center>  <a class="btn btn-primary btn-lg" href="actionpdf.php" role="button">Exportar a PDF <i class="fa fa-file-pdf-o"></i> </a></center>
